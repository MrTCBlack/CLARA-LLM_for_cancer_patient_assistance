...
for i in range(len(questions)):
    ...
    # Precentage of words/phrases in prediction that also appear in the reference
    ...
    # Not the best for long answer responses generated by model.
    ...
    # Looking at how much of the reference appears in the prediction
    ...
    print(f"ROUGE1: {rouge_scores["rouge1"][i]}")
    print(f"ROUGE2: {rouge_scores["rouge2"][i]}")
    print(f"ROUGEL: {rouge_scores["rougeL"][i]}")
    print(f"ROUGELsum: {rouge_scores["rougeLsum"][i]}\n")

    # METEOR (Metric for Evaluation of Translation with Explicit ORdering)
    # Improves over BLEU by incorporating synonym matching, stemming,
    ...
    # BERTScore
    # Uses a pretrained language model (e.g., BERT) to compute semantic similarity
